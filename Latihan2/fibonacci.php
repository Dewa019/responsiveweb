...
<head>
    <title>Fibonacci Dewa Yogik</title>
    <meta charset="utf-8">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-5">
                <form method="POST" action="#" class="bg-white form-container p-3" id="forminput">
                    <h2><b>Deret Fibonacci Dewa</b></h2>
                    ...
                    <div class="form-group">
                        ...
                        <h4 style="background-color:white; color: black;; text-align: center; border-radius: 4px;"><?php echo $deret; ?></h4>
                    </div>
                </form>
            </div>
        </div>
